...
export default function TermsPage() {
  return (
    <article style={S.wrap}>
      ...
      <h2 style={S.h2}>제7조 (수치 대조와 책임의 한계)</h2>
      <p style={S.p}>
        서비스는 생성물에 쓰인 수치를 논문 원문과 대조하고, 그 결과(확인·미확인)를
        화면에 표시합니다. 다만 이 대조는 이용자의 검토를 돕기 위한 것이며, AI가 생성한
        콘텐츠 전체의 정확성을 보장하지는 않습니다. 원문 자체에 오류가 있는 경우도
        있으므로, 게시 전 최종 확인의 책임은 이용자에게 있습니다.
      </p>
      <p style={S.p}>
        생성물을 외부에 게시·배포하여 발생하는 결과에 대한 책임은 이용자에게 있습니다.
      </p>
