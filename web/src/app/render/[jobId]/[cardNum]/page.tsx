...
export default function RenderPage() {
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: 1080, height: 1080, overflow: 'hidden', background: '#fff' }}>
      <CardRenderer card={card} theme={theme} bgColor={cardData?.bg_color} accentColor={cardData?.accent_color} fontPairing={cardData?.font_pairing} setKey={cardData?.set_key} mode="render" scale={1} />
    </div>
  )
}
