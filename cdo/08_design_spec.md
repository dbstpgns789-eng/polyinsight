# 08 · PaperSweep 카드뉴스 디자인 스펙

> PaperSweep Design Spec v2.0 | 2026-05-11
> KITECH 샘플 레퍼런스 기반 → PaperSweep 독자 디자인 시스템으로 재정의
>
...
PaperSweep가 레퍼런스로 삼은 시리즈는 3종이며, 각각 독립적인 레이아웃 패턴을 가진다.
PaperSweep 출력물은 이 시리즈에 종속되지 않으며, 아래는 학습 레퍼런스 분류다.
...
| v2.0 | 2026-05-11 | PaperSweep 독자 디자인 시스템으로 재정의. 색상 토큰 2계층 구조 전환, 역할 기반 토큰명 통일, Type H·I·J MVP 제외 표기, Type K 기관 브랜드 클로징으로 재정의, 카드 매핑 Pydantic 모델 기반으로 교체, TOPIC_COLOR_SUGGESTIONS 도입 |
